...
public class HbDataCurServiceImpl implements IHbDataCurService {
	 ...
	 * @param inPar
	 * @param responseData
	 * @see com.aps.monitor.service.IHbDataCurService#refNbDataLatest(javax.servlet.http.HttpSession,
	 *      java.lang.String, com.aps.monitor.comm.ResponseData)
	 */
	@Override
	public void refNbDataLatest(HttpSession httpSession, String inPar, ResponseData responseData) {

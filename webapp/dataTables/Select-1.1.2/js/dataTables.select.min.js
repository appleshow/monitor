...
a.settings()[0];if(b._select.info&&b.aanFeatures.i){var c=e('<span class="select-info"/>'),d=function(b,d){c.append(e('<span class="select-item"/>').append(a.i18n("select."+b+"s",{_:"%d "+b+" 被选中","0":"",1:"1 "+b+" 被选中"},d)))};d("行",a.rows({selected:!0}).flatten().length);d("列",a.columns({selected:!0}).flatten().length);d("单元格",a.cells({selected:!0}).flatten().length);e.each(b.aanFeatures.i,function(b,a){var a=e(a),d=a.children("span.select-info");d.length&&d.remove();""!==c.text()&&

...
(function($) {
	$.parser = {
		...
		plugins : [ "draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree", "textbox", "filebox", "combo",
				"combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner", "calendar", "datebox", "datetimebox",
	...
	function _5a7(_5a8, _5a9) {
		...
		var _5ad = $(
				"<div class=\"datagrid-wrap\">" + "<div class=\"datagrid-view\">" + "<div class=\"datagrid-view1\">" + "<div class=\"datagrid-header\">"
						...
						+ "<div class=\"datagrid-footer-inner\"></div>" + "</div>" + "</div>" + "</div>" + "</div>").insertAfter(_5a8);
		_5ad.panel({
			doSize : false,
			cls : "datagrid"
		});
			...
			for (var i = 0; i < _5bc.length; i++) {
				...
				for (var j = 0; j < cols.length; j++) {
					...
					if (col.checkbox) {
						...
						$("<div class=\"datagrid-header-check\"></div>").html("<input type=\"checkbox\" disabled />").appendTo(td);
					} else {
						if (col.field) {
							td.attr("field", col.field);
			...
			function _757(_758) {
				...
				for (var i = data.rows.length - 1; i >= _755; i--) {
					...
					if (_758 && opts.rownumbers) {
						...
						// ***************
						if (!isNaN(tr.find("div.datagrid-cell-rownumber").html())) {
